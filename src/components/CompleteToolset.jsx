  ...
  const toolsArrayFE = [
    {
      ...
      logo: (
        <ReactSVG
          ...
          className="absolute opacity-100 w-16 h-16 bottom-4 right-5 "
        />
      ),
      png: ReactPNG,
    ...
    },
    {
      ...
      logo: (
        <VueSVG className="absolute opacity-100 w-16 h-16 bottom-4 right-5 " />
      ),
      png: VuePNG,
    ...
    },
    {
      ...
      description:
        'Railway scales apps to meet user demand, automagically, based on load.',
      logo: (
        <TailwindSVG className="absolute opacity-100 w-16 h-16 bottom-4 right-5 " />
      ),
      png: TailwindPNG,
    ...
    },
    {
      ...
      description:
        'Railway scales apps to meet user demand, automagically, based on load.',
      logo: (
        <MaterialSVG className="absolute opacity-100 w-16 h-16 bottom-4 right-5 " />
      ),
      png: MaterialPNG,
    ...
    },
    {
      ...
      logo: (
        <ThreeSVG className="absolute opacity-100 w-16 h-16 bottom-4 right-5 " />
      ),
      png: ThreePNG,
  ...
  const toolsArrayBE = [
    {
      ...
      description:
        'Railway scales apps to meet user demand, automagically, based on load.',
      logo: (
        <NodeSVG className="absolute opacity-100 w-16 h-16 bottom-4 right-5 " />
      ),
      png: NodePNG,
    ...
    },
    {
      ...
      description:
        'Railway scales apps to meet user demand, automagically, based on load.',
      logo: (
        <ExpressSVG className="absolute opacity-100 w-16 h-16 bottom-4 right-5 " />
      ),
      png: ExpressPNG,
    ...
    },
    {
      ...
      description:
        'Railway scales apps to meet user demand, automagically, based on load.',
      logo: (
        <MongoSVG className="absolute opacity-100 w-16 h-16 bottom-4 right-5 " />
      ),
      png: MongoPNG,
    ...
    },
    {
      ...
      description:
        'Railway scales apps to meet user demand, automagically, based on load.',
      logo: (
        <LaravelSVG className="absolute opacity-100 w-16 h-16 bottom-4 right-5 " />
      ),
      png: LaravelPNG,
      scale: new Vector3(35, 35, 35),
    },
    {
      ...
      description:
        'Railway scales apps to meet user demand, automagically, based on load.',
      logo: (
        <MysqlSVG className="absolute opacity-100 w-16 h-16 bottom-4 right-5 " />
      ),
      png: MysqlPNG,
  ...
  const toolsArrayDO = [
    {
      ...
      description:
        'Railway scales apps to meet user demand, automagically, based on load.',
      logo: (
        <DockerSVG className="absolute opacity-100 w-16 h-16 bottom-4 right-5 " />
      ),
      png: DockerPNG,
    ...
    },
    {
      ...
      description:
        'Railway scales apps to meet user demand, automagically, based on load.',
      logo: (
        <AwsSVG className="absolute opacity-100 w-16 h-16 bottom-4 right-5 " />
      ),
      png: AwsPNG,
    ...
    },
    {
      ...
      description:
        'Railway scales apps to meet user demand, automagically, based on load.',
      logo: (
        <GcpSVG className="absolute opacity-100 w-16 h-16 bottom-4 right-5 " />
      ),
      png: GcpPNG,
