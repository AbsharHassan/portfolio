  ...
  const toolsArray = [
    {
      ...
      logo: (
        <ReactSVG className="absolute opacity-100 w-10 h-10 bottom-3 right-3 " />
      ),
    },
    {
      id: 2,
      ...
      description:
        'Railway scales apps to meet user demand, automagically, based on load.',
      logo: (
        <NodeSVG className="absolute opacity-100 w-10 h-10 bottom-3 right-3 " />
      ),
    },
    {
      id: 3,
      ...
      description:
        'Railway scales apps to meet user demand, automagically, based on load.',
      logo: (
        <LaravelSVG className="absolute opacity-100 w-10 h-10 bottom-3 right-3 " />
      ),
    },
    {
      id: 4,
      ...
      description:
        'Railway scales apps to meet user demand, automagically, based on load.',
      logo: (
        <ExpressSVG className="absolute opacity-100 w-10 h-10 bottom-3 right-3 " />
      ),
    },
    {
      id: 5,
      ...
      description:
        'Railway scales apps to meet user demand, automagically, based on load.',
      logo: (
        <MongoSVG className="absolute opacity-100 w-10 h-10 bottom-3 right-3 " />
      ),
    },
    {
      id: 6,
      ...
      description:
        'Railway scales apps to meet user demand, automagically, based on load.',
      logo: (
        <MaterialSVG className="absolute opacity-100 w-10 h-10 bottom-3 right-3 " />
      ),
    },
    {
      id: 7,
      ...
      description:
        'Railway scales apps to meet user demand, automagically, based on load.',
      logo: (
        <VueSVG className="absolute opacity-100 w-10 h-10 bottom-3 right-3 " />
      ),
    },
    {
      id: 8,
      ...
      description:
        'Railway scales apps to meet user demand, automagically, based on load.',
      logo: (
        <MysqlSVG className="absolute opacity-100 w-10 h-10 bottom-3 right-3 " />
      ),
    },
    {
      id: 9,
      ...
      description:
        'Railway scales apps to meet user demand, automagically, based on load.',
      logo: (
        <TailwindSVG className="absolute opacity-100 w-10 h-10 bottom-3 right-3 " />
      ),
    },
    {
      id: 10,
      ...
      description:
        'Railway scales apps to meet user demand, automagically, based on load.',
      logo: (
        <DockerSVG className="absolute opacity-100 w-10 h-10 bottom-3 right-3 " />
      ),
    },
    {
      id: 11,
      ...
      description:
        'Railway scales apps to meet user demand, automagically, based on load.',
      logo: (
        <AwsSVG className="absolute opacity-100 w-10 h-10 bottom-3 right-3 " />
      ),
    },
    {
      id: 12,
      ...
      description:
        'Railway scales apps to meet user demand, automagically, based on load.',
      logo: (
        <GcpSVG className="absolute opacity-100 w-10 h-10 bottom-3 right-3 " />
      ),
    },
  ]
  ...
  return (
    <div className="max-w-7xl mx-auto ">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-4 gap-8">
        {toolsArray.map((tool) => (
          <div
            className="grid grid-cols-4 flex-grow h-[140px] card-shadow rounded-xl border border-[#183367] relative pt-3 pl-4 text-[#a1a0ab] bg-[#111018]"
            key={tool.id}
          >
            <div className="col-span-3">
              <p className="text-[#8caef2] text-lg font-semibold mb-2">
                <code>
                  &lt;{tool.title}
                  <span className=""> /</span>&gt;
                </code>
